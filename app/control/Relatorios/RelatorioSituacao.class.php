...
class RelatorioSituacao extends TPage
{
    ...
    public function __construct()
    {
        ...
        // create the form
        $this->form = new TQuickForm('form_situacoes');
        $this->form->class = 'tform'; // CSS class
        $this->form->setFormTitle('Relatório de Situação');
    ...
    function onReload($param = NULL)
    {
        try
        {
            ...
            $repository = new TRepository('Situacao');
    ...
    function onSave()
    {
        try
        {
            ...
            $category = $this->form->getData('Situacao');
    ...
    function onDelete($param)
    {
        ...
        new TQuestion('Deseja realmente Excluir a Seção ?', $action);
    }
