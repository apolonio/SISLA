...
class RelatorioSecoes extends TPage
{
    ...
    public function __construct()
    {
        ...
        $this->form->setFormTitle('Relatório de Seções');
    ...
    function onReload($param = NULL)
    {
        try
        {
            ...
            $repository = new TRepository('Secoes');
    ...
    function onSave()
    {
        try
        {
            ...
            $category = $this->form->getData('Secoes');
