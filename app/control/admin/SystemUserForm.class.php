...
class SystemUserForm extends TPage
{
    ...
    function __construct()
    {
        ...
        $program_id          = new TDBSeekButton('program_id', 'fiscalizacao', 'form_System_user', 'SystemProgram', 'name', 'programs_id', 'programs_name');
        $program_name        = new TEntry('program_name');
        $groups              = new TDBCheckGroup('groups','fiscalizacao','SystemGroup','id','name');
        $frontpage_id        = new TDBSeekButton('frontpage_id', 'fiscalizacao', 'form_System_user', 'SystemProgram', 'name', 'frontpage_id', 'frontpage_name');
